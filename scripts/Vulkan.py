...
GCE_VULKAN_VERSION = '1.3.216.0'
VULKAN_SDK_EXE_PATH = 'GCEngine/vendor/VulkanSDK/VulkanSDK.exe'
...
def CheckVulkanSDK():
    if (VULKAN_SDK is None):
        ...
        InstallVulkanPrompt()
        return False
    elif (GCE_VULKAN_VERSION not in VULKAN_SDK):
        print(f"Located Vulkan SDK at {VULKAN_SDK}")
        print(f"You don't have the correct Vulkan SDK version! (GCE requires {GCE_VULKAN_VERSION})")
        InstallVulkanPrompt()
        return False
...
VulkanSDKDebugLibsURL = 'https://files.lunarg.com/SDK-1.3.216.0/VulkanSDK-1.3.216.0-DebugLibs.zip'
OutputDirectory = "GCEngine/vendor/VulkanSDK"
